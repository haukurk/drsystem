...
Design pattern, tools and frameworks used: Entity Framework 6 (Code first), Repository pattern for data layer, DI design with Ninject, Model factory pattern to control WebAPI responses, (TODO: JWT Token for authoriziation - scalable auth -).
